...
int main(){
    ...
    {
        i&0x1 ? printf("\t%d\n", i):printf("%d\n",i);
        /*utiliza um operador ternário, se a condição "i&0x01==1" 
        (1 se for ímpar) for cumprida, imprime na tela o valor de
        i com um \t (tab) se não for cumprida, apenas imprime
